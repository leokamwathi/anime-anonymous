...
fusiontabledata += topList+'<br/><div class="animeTitle" >'+title+'</div><div><br/></div><div style="float: left;"><table cellspace= 2 cellpadding = 2><tr><td><div style="float: left;"><a name="fb_share" type="button_count" ></a></td><td><div style="float: left;"><fb:add-to-timeline show-faces="false" width="80"  mode="button"></fb:add-to-timeline></td><td><div style="float: left;"><fb:like href="http://apps.facebook.com/anime-anonymous/?id='+mal_id+'" send="true" width="400" show_faces="false" font=""></fb:like></td><td><div style="float: right;"><fb:login-button show-faces="false" width="100" max-rows="0" scope="email,publish_stream,publish_actions"></fb:login-button></div></td></tr></table></div>';
