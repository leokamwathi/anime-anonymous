...
var fusiontabledata = "";
fusiontabledata += topList+'<br/><div class="animeTitle" >'+title+'</div><div style="float: left;"><fb:like href="http://apps.facebook.com/anime-anonymous/?id='+mal_id +'" send="true" width="700" show_faces="false" font=""></fb:like></div>';
